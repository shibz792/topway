...
export const markets: Market[] = [
  ...
  { slug:"turkiye", name:"Türkiye (Turkey)", status:"Strategic expansion", region:"Europe & Asia", summary:"A strategic expansion market for future employer-sponsored opportunities.", industries:["Hospitality","Manufacturing","Construction"], roles:["Hospitality staff","Technicians","Production workers"] },
