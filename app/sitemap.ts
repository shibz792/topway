...
export default function sitemap():MetadataRoute.Sitemap{
 const pages=["","about","services","recruitment-services","domestic-recruitment","industries","global-markets","recruitment-process","employers","candidates","opportunities","job-registry","leadership","licence-compliance","contact","privacy-policy","terms"];
